...
// Purpose: Serves safe local project folder discovery and creation requests from the mobile app.
...
async function requireUsableDirectory(candidatePath, options = {}) {
  ...
  if (!validation.exists) {
    throw projectError("missing_directory", "That folder does not exist on this computer.");
  }
